        ...
        >
          {experiences.map((experience, index) => (
            <motion.div
              ...
              variants={item}
            >
              <div className="bg-[#222831] rounded-lg p-6 shadow-lg border border-[#948979]/20 hover:border-[#948979]/40 transition-colors duration-300">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                  <div className="mb-2 md:mb-0">
                    <h3 className="text-xl font-semibold text-[#DFD0B8] mb-1">
                      {experience.title}
                    </h3>
                    <h4 className="text-lg text-[#948979] font-medium">
                      {experience.company}
                    </h4>
                  </div>
                  <div className="flex flex-col md:items-end text-sm text-[#948979]">
